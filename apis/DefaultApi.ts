...
export class DefaultApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async beginLiveActivity(appId: string, activityType: string, beginLiveActivityRequest: BeginLiveActivityRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (activityType === null || activityType === undefined) {
            throw new RequiredError("DefaultApi", "beginLiveActivity", "activityType");
        }

        // verify required parameter 'beginLiveActivityRequestBody' is not null or undefined
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(beginLiveActivityRequest, "BeginLiveActivityRequestBody", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
