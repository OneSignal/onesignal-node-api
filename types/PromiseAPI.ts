...
export class PromiseDefaultApi {
     ...
     */
    public estimateNotificationRecipients(estimateNotificationRecipientsRequest: EstimateNotificationRecipientsRequest, _options?: Configuration): Promise<EstimateNotificationRecipientsSuccessResponse> {
     ...
     * @param appId Your OneSignal App ID in UUID v4 format.
     */
    public getEmailReputation(appId: string, _options?: Configuration): Promise<EmailReputationResponse> {
     ...
     */
    public getNotifications(appId: string, limit?: number, offset?: number, kind?: 0 | 1 | 3, timeOffset?: string, _options?: Configuration): Promise<NotificationSlice> {
     ...
     */
    public updateSegment(appId: string, segmentId: string, updateSegmentRequest?: UpdateSegmentRequest, _options?: Configuration): Promise<UpdateSegmentSuccessResponse> {
