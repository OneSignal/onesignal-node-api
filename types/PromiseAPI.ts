...
export class PromiseDefaultApi {
     ...
     */
    public cancelNotification(app_id: string, notification_id: string, _options?: Configuration): Promise<InlineResponse2001> {
        const result = this.api.cancelNotification(app_id, notification_id, _options);
     ...
     * @param player 
     */
    public createPlayer(player: Player, _options?: Configuration): Promise<InlineResponse2004> {
     ...
     * @param segment 
     */
    public createSegments(app_id: string, segment?: Segment, _options?: Configuration): Promise<InlineResponse201> {
        const result = this.api.createSegments(app_id, segment, _options);
        return result.toPromise();
    }
     ...
     */
    public deletePlayer(app_id: string, player_id: string, _options?: Configuration): Promise<InlineResponse2001> {
        const result = this.api.deletePlayer(app_id, player_id, _options);
        return result.toPromise();
    }
     ...
     */
    public deleteSegments(app_id: string, segment_id: string, _options?: Configuration): Promise<InlineResponse2003> {
        const result = this.api.deleteSegments(app_id, segment_id, _options);
        return result.toPromise();
    }
     ...
     */
    public exportPlayers(app_id: string, export_players_request_body?: ExportPlayersRequestBody, _options?: Configuration): Promise<InlineResponse2005> {
        const result = this.api.exportPlayers(app_id, export_players_request_body, _options);
        return result.toPromise();
    }
     ...
     */
    public getApp(app_id: string, _options?: Configuration): Promise<App> {
        const result = this.api.getApp(app_id, _options);
        return result.toPromise();
    }
     ...
     * View apps
     */
    public getApps(_options?: Configuration): Promise<string> {
     ...
     * @param notification_id 
     */
    public getNotification(app_id: string, notification_id: string, _options?: Configuration): Promise<Notification> {
        const result = this.api.getNotification(app_id, notification_id, _options);
        return result.toPromise();
    }
     ...
     */
    public getNotificationHistory(notification_id: string, get_notification_request_body: GetNotificationRequestBody, _options?: Configuration): Promise<InlineResponse2002> {
        const result = this.api.getNotificationHistory(notification_id, get_notification_request_body, _options);
        return result.toPromise();
    }
     ...
     */
    public getNotifications(app_id: string, limit?: string, offset?: number, kind?: 0 | 1 | 3, _options?: Configuration): Promise<NotificationSlice> {
        const result = this.api.getNotifications(app_id, limit, offset, kind, _options);
        return result.toPromise();
    }
     ...
     */
    public getOutcomes(app_id: string, outcome_names: string, outcome_names2?: string, outcome_time_range?: string, outcome_platforms?: string, outcome_attribution?: string, _options?: Configuration): Promise<Array<OutcomeData>> {
        const result = this.api.getOutcomes(app_id, outcome_names, outcome_names2, outcome_time_range, outcome_platforms, outcome_attribution, _options);
        return result.toPromise();
    }
     ...
     */
    public getPlayer(app_id: string, player_id: string, email_auth_hash?: string, _options?: Configuration): Promise<Player> {
        const result = this.api.getPlayer(app_id, player_id, email_auth_hash, _options);
        return result.toPromise();
    }
     ...
     */
    public getPlayers(app_id: string, limit?: string, offset?: number, _options?: Configuration): Promise<PlayerSlice> {
        const result = this.api.getPlayers(app_id, limit, offset, _options);
        return result.toPromise();
    }
     ...
     * @param app 
     */
    public updateApp(app_id: string, app: App, _options?: Configuration): Promise<App> {
        const result = this.api.updateApp(app_id, app, _options);
        return result.toPromise();
    }
     ...
     * @param player 
     */
    public updatePlayer(player_id: string, player: Player, _options?: Configuration): Promise<InlineResponse2001> {
        const result = this.api.updatePlayer(player_id, player, _options);
        return result.toPromise();
    }
     ...
     */
    public updatePlayerTags(app_id: string, external_user_id: string, update_player_tags_request_body?: UpdatePlayerTagsRequestBody, _options?: Configuration): Promise<InlineResponse2003> {
        const result = this.api.updatePlayerTags(app_id, external_user_id, update_player_tags_request_body, _options);
        return result.toPromise();
    }
