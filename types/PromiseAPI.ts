...
export class PromiseDefaultApi {
     ...
     */
    public deletePlayer(appId: string, playerId: string, _options?: Configuration): Promise<InlineResponse2001> {
     ...
     */
    public deleteSegments(appId: string, segmentId: string, _options?: Configuration): Promise<InlineResponse2003> {
     ...
     */
    public exportPlayers(appId: string, exportPlayersRequestBody?: ExportPlayersRequestBody, _options?: Configuration): Promise<InlineResponse2005> {
     ...
     * @param notificationId 
     */
    public getNotification(appId: string, notificationId: string, _options?: Configuration): Promise<Notification & DeliveryData & OutcomesData & object> {
     ...
     */
    public getNotifications(appId: string, limit?: string, offset?: number, kind?: 0 | 1 | 3, _options?: Configuration): Promise<NotificationSlice> {
     ...
     */
    public getPlayers(appId: string, limit?: string, offset?: number, _options?: Configuration): Promise<PlayerSlice> {
     ...
     */
    public updatePlayerTags(appId: string, externalUserId: string, updatePlayerTagsRequestBody?: UpdatePlayerTagsRequestBody, _options?: Configuration): Promise<InlineResponse2003> {
