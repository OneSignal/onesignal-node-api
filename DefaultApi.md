...
let body:.DefaultApiCreatePlayerRequest = {
  ...
  player: {
    ...
    session_count: 1,
    tags: {},
    amount_spent: "amount_spent_example",
    created_at: 1,
    playtime: 1,
    badge_count: 1,
    last_active: 1,
...
# **deletePlayer**
> InlineResponse2001 deletePlayer()
...
# **deleteSegments**
> InlineResponse2003 deleteSegments()
...
# **exportPlayers**
> InlineResponse2005 exportPlayers()
...
# **getNotification**
> Notification & DeliveryData & OutcomesData & object getNotification()
...
let body:.DefaultApiGetNotificationsRequest = {
  ...
  appId: "app_id_example",
  // string | How many notifications to return.  Max is 50.  Default is 50. (optional)
  limit: "limit_example",
 ...
 **limit** | [**string**] | How many notifications to return.  Max is 50.  Default is 50. | (optional) defaults to undefined
...
let body:.DefaultApiGetPlayersRequest = {
  ...
  appId: "app_id_example",
  // string | How many devices to return. Max is 300. Default is 300 (optional)
  limit: "limit_example",
 ...
 **limit** | [**string**] | How many devices to return. Max is 300. Default is 300 | (optional) defaults to undefined
...
# **updatePlayerTags**
> InlineResponse2003 updatePlayerTags()
