...
* add v5.18.0 package updates ([61b7ab5](https://github.com/OneSignal/onesignal-node-api/commit/61b7ab5fe2455fb0dbd7f896b54c2b9265291147))
* add v5.18.0 package updates ([#219](https://github.com/OneSignal/onesignal-node-api/issues/219)) ([8c2763c](https://github.com/OneSignal/onesignal-node-api/commit/8c2763c377015557af4a9d53f711b017c7b87687)), closes [OneSignal/api-client-libraries#464](https://github.com/OneSignal/api-client-libraries/issues/464) [OneSignal/api-client-libraries#465](https://github.com/OneSignal/api-client-libraries/issues/465)

## [5.17.0](https://github.com/OneSignal/onesignal-node-api/compare/v5.16.0...v5.17.0) (2026-08-31)

### Features

* add v5.17.0 package updates ([8bc453f](https://github.com/OneSignal/onesignal-node-api/commit/8bc453f15ff857097981d2a8c1c0b2f9a094e7f6))
* add v5.17.0 package updates ([#216](https://github.com/OneSignal/onesignal-node-api/issues/216)) ([a749b2e](https://github.com/OneSignal/onesignal-node-api/commit/a749b2eb681f98461802700983b5d8052d0f4cd7)), closes [OneSignal/api-client-libraries#459](https://github.com/OneSignal/api-client-libraries/issues/459)

## [5.16.0](https://github.com/OneSignal/onesignal-node-api/compare/v5.15.0...v5.16.0) (2026-08-28)

### Features

* add v5.16.0 package updates ([a97f9bf](https://github.com/OneSignal/onesignal-node-api/commit/a97f9bfe0f88a2b4151cd381c681d238d1888063))
* add v5.16.0 package updates ([#214](https://github.com/OneSignal/onesignal-node-api/issues/214)) ([716bb6a](https://github.com/OneSignal/onesignal-node-api/commit/716bb6ad91fcb326ab011acef8190a5c9e4de105)), closes [OneSignal/api-client-libraries#452](https://github.com/OneSignal/api-client-libraries/issues/452)
...
* add v5.14.0 package updates ([6c02363](https://github.com/OneSignal/onesignal-node-api/commit/6c02363743d080cb6f0f33adaebf0bf9f4aa2418))
* add v5.14.0 package updates ([#208](https://github.com/OneSignal/onesignal-node-api/issues/208)) ([87611e3](https://github.com/OneSignal/onesignal-node-api/commit/87611e35d6ec0f9ef5e946776b333b8b2859640a)), closes [OneSignal/api-client-libraries#450](https://github.com/OneSignal/api-client-libraries/issues/450)

## [5.13.2](https://github.com/OneSignal/onesignal-node-api/compare/v5.13.1...v5.13.2) (2026-08-12)
